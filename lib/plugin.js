module.exports = function(opts) {
  ...
  function findDefaultPropsIfAny(path) {
    ...
    // body[x] <= isClassProperty
    // body[x].key == 'defaultProps'
    // body[x].value <= ObjectExpression
    // body[x].value.properties[x] <= Property
    // body[x].value.properties[x].key.name
    // body[x].value.properties[x].value.value
